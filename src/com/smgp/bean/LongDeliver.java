...
public class LongDeliver {
	...
	public LongDeliver(DeliverMessage delivermsg) {
		...
		//System.out.println("�ܹ�����" + this.Total);
	...
	public DeliverMessage MergeDeliver() {
		...
		//System.out.println("�ܳ��ȣ�" + this.TotalMsgLengh);
		int nav = 0;
	...
	public DeliverMessage[] CheckIfOverTime(int second) {
		//System.out.println("��ʱ:"+(System.currentTimeMillis() - this.lastactivetime)+"����,"+"��Ҫ:"+second*1000);
