...
public class Submit extends SGIPCommand {
	...
	public byte[] getMessageContentByte() {
		return messageContentByte;
	}

	public void setMessageContentByte(byte[] messageContentByte) {
		this.messageContentByte = messageContentByte;
	}
	...
	private void calcute()
	{
			...
			byte[] mcBytes = null;
			 ...
			 if(tpUdhi==0){
				 try
					{
						mcBytes = this.messageContent.getBytes("iso-10646-ucs-2");
			...
			int length = this.messageContentByte.length;
