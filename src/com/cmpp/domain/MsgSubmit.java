...
import com.cmpp.util.MsgConfig;
...
//	private String linkID = "";
	...
	public byte[] toByteArray(){
		...
		try {
			...
			String sss=MsgConfig.getServiceId();
			MsgUtils.writeString(dous,MsgConfig.getServiceId(),10);//Service_Id 业务标识，是数字、字母和符号的组合。
